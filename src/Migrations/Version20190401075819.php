 ...
 */
final class Version20190401075819 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_session ADD steam_user_id INT NOT NULL, DROP user_id');
        $this->addSql('DROP INDEX IDX_96737FF1A76ED395 ON achievement');
        $this->addSql('ALTER TABLE achievement ADD steam_user_id INT NOT NULL, DROP user_id, CHANGE overall_achievements overall_achievements INT NOT NULL');
        $this->addSql('DROP INDEX IDX_FCDE7170A76ED395 ON playtime');
        $this->addSql('ALTER TABLE playtime ADD steam_user_id INT NOT NULL, DROP user_id');
        $this->addSql('DROP INDEX IDX_65741E25A76ED395 ON game_stats');
        $this->addSql('ALTER TABLE game_stats ADD steam_user_id INT NOT NULL, DROP user_id');
        $this->addSql('DROP INDEX IDX_82E16696A76ED395 ON game_sessions_per_month');
        $this->addSql('ALTER TABLE game_sessions_per_month ADD steam_user_id INT NOT NULL, DROP user_id');
        $this->addSql('DROP INDEX IDX_9D969260A76ED395 ON overall_game_stats');
        $this->addSql('ALTER TABLE overall_game_stats ADD steam_user_id INT NOT NULL, DROP user_id');
        ...
        $this->addSql('ALTER TABLE playtime_per_month ADD steam_user_id INT NOT NULL, DROP user_id, DROP game_stats_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE achievement ADD user_id INT DEFAULT NULL, DROP steam_user_id, CHANGE overall_achievements overall_achievements INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE game_session ADD user_id INT DEFAULT NULL, DROP steam_user_id');
        ...
        $this->addSql('ALTER TABLE game_sessions_per_month ADD user_id INT DEFAULT NULL, DROP steam_user_id');
        ...
        $this->addSql('ALTER TABLE game_stats ADD user_id INT DEFAULT NULL, DROP steam_user_id');
        ...
        $this->addSql('ALTER TABLE overall_game_stats ADD user_id INT DEFAULT NULL, DROP steam_user_id');
        ...
        $this->addSql('ALTER TABLE playtime ADD user_id INT DEFAULT NULL, DROP steam_user_id');
        ...
        $this->addSql('ALTER TABLE playtime_per_month ADD user_id INT DEFAULT NULL, ADD game_stats_id INT DEFAULT NULL, DROP steam_user_id');
